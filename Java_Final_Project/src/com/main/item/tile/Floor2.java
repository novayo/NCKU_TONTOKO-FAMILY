...
public class Floor2 extends Tile{
	...
	public void render(Graphics g) {
		g.drawImage(Game.floor2Image[0].getBufferedImage(), three_floor_x[0], y, width, height, null);
		g.drawImage(Game.floor2Image[1].getBufferedImage(), three_floor_x[1], y, width, height, null);
		g.drawImage(Game.floor2Image[2].getBufferedImage(), three_floor_x[2], y, width, height, null);
	}
