...
public class Floor1_Obstacle extends Tile {

	public Floor1_Obstacle(Id id, Handler handler, int x, int y, int width, int height) {
	...
	public void render(Graphics g) {
		// 設定圖片
		g.drawImage(Game.floor1_obstacleImage.getBufferedImage(), x, y, width, height, null);
	}
