...
//
//public class Floor3_Obstacle extends Tile {
//
//	public Floor3_Obstacle(Id id, Handler handler, int x, int y, int width, int height) {
...
//		// 設定圖片
//		g.drawImage(Game.floor3_obstacleImage.getBufferedImage(), x, y, width, height, null);
//	}
//
//	@Override
//	public void update() {
