...
public class Handler implements GameParameter{
	...
	public void createStuff() {
		...
		addTile(new Floor1(Id.Floor1, Game.handler, 0, GameParameter.HEIGHT*1/4-32, GameParameter.FLOOR_WIDTH, Game.FLOOR_HEIGHT)); // 地板要設定3個，每個長度都要大於等於視窗程度的一半(400)，
		addTile(new Floor2(Id.Floor2, Game.handler, 0, GameParameter.HEIGHT*2/4-32, GameParameter.FLOOR_WIDTH, Game.FLOOR_HEIGHT)); // 地板要設定3個，每個長度都要大於等於視窗程度的一半(400)，
		addTile(new Floor3(Id.Floor3, Game.handler, 0, GameParameter.HEIGHT*3/4-32, GameParameter.FLOOR_WIDTH, Game.FLOOR_HEIGHT)); // 地板要設定3個，每個長度都要大於等於視窗程度的一半(400)，
		addTile(new Floor4(Id.Floor4, Game.handler, 0, GameParameter.HEIGHT*4/4-32, GameParameter.FLOOR_WIDTH, Game.FLOOR_HEIGHT)); // 地板要設定3個，每個長度都要大於等於視窗程度的一半(400)，
